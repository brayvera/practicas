    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Agregar Semestre/Curso</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="position_add.php">
          		  <div class="form-group">
                  	<label for="title" class="col-sm-3 control-label">Semestre</label>
                ...
                <div class="form-group">
                    <label for="rate" class="col-sm-3 control-label">Curso</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_title" class="col-sm-3 control-label">Semestre</label>
                ...
                <div class="form-group">
                    <label for="edit_rate" class="col-sm-3 control-label">Curso</label>
