      ...
      <div class="row">
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              <p>Registrados totales</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-stalker"></i>
            </div>
            <a href="ed.php" class="small-box-footer">Más información<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <!--<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="asis.php" class="small-box-footer">Más información<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>-->
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
